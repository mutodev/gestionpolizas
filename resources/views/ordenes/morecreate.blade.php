...
@endif
    ...
    <input type="text" name="order_tipo" id="order_tipo" value="orden" hidden>
                ...
                <div class=" row form-group " >
                    <div class="col">
                    <h1><label>Número de Orden : {{$dato['NUMERO']}}</label></h1>



                    <input type="text" class="form-control {{ $errors->has('order_number') ? 'error' : '' }}" name="order_number" id="order_number" value="{{$dato['NUMERO']}}" hidden>
                    <!-- Error -->
